...
* Road to 1.0 [21/22]
** [ ] Generate thread completions for ~4g-thread~ [1/4]
*** [ ] cache catalogs 
*** [ ] store in hash-table 4g--catalogs
*** [ ] Make thread completions searchable by title
...
*** [ ] Advise relevant Org commands to add reps to list 
**** [ ] Open/Cycle subheadings
